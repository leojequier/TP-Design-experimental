...
#Normal
par(mfrow = c(1,1))
plot(celllog$time,celllog$MixC_SCmoy_G,log="y",xlim=c(0,48),ylim=c(log(2950),log(4028683330)), cex.main=1.2,
     cex.lab=1.2,type="o",main="SC growth\n Experiment 1",xlab= "Time [Hours]", ylab="log(SC count)")
#replicats
points(celllog$time,celllog$MixC_SC1_G,type = "p")
points(celllog$time,celllog$MixC_SC2_G,type = "p")
points(celllog$time,celllog$MixC_SC3_G,type = "p")
#lines sc tol
points(celllog$time,celllog$Tol_SCmoy_G, type="o", col="red")
#replicats
points(celllog$time,celllog$Tol_SC1_G, type="p", col="red")
points(celllog$time,celllog$Tol_SC2_G, type="p", col="red")
points(celllog$time,celllog$Tol_SC3_G, type="p", col="red")
#lines ppsc mixc
points(celllog$time,celllog$MixC_PPSCmoy_G, type="l", col="blue")
#rep 
points(celllog$time,celllog$MixC_PPSC1_G, type="p", col="blue")
points(celllog$time,celllog$MixC_PPSC2_G, type="p", col="blue")
points(celllog$time,celllog$MixC_PPSC3_G, type="p", col="blue")
#line ppsc tol
points(celllog$time,celllog$Tol_PPSCmoy_G, type="l", col="orange")
#rep
points(celllog$time,celllog$Tol_PPSC1_G, type="p", col="orange")
points(celllog$time,celllog$Tol_PPSC2_G, type="p", col="orange")
points(celllog$time,celllog$Tol_PPSC3_G, type="p", col="orange")
...
plot(celllog$time, celllog$Tol_PPmoy_R,cex.main=1.2,
     cex.lab=1.2,xlim=c(0,48),ylim=c(log(2950),log(4028683330)), type="l", col = "red"
     ,main="PP growth\n Experiment 1",xlab= "Time [Hours]", ylab="log(PP count)")
## replicats
points(celllog$time,celllog$Tol_PP1_R, type="p", col="red")
points(celllog$time,celllog$Tol_PP2_R, type="p", col="red")
points(celllog$time,celllog$Tol_PP3_R, type="p", col="red")
#lignes ppsc
points(celllog$time,celllog$Tol_PPSCmoy_R, type="l", col="orange")
# replicats
points(celllog$time,celllog$Tol_PPSC1_R, type="p", col="orange")
points(celllog$time,celllog$Tol_PPSC2_R, type="p", col="orange")
points(celllog$time,celllog$Tol_PPSC3_R, type="p", col="orange")
#lignes pppsc
points(celllog$time,celllog$MixC_PPmoy_R, type="l", col="black")
#replicats
points(celllog$time,celllog$MixC_PP1_R, type="p", col="black")
points(celllog$time,celllog$MixC_PP2_R, type="p", col="black")
points(celllog$time,celllog$MixC_PP3_R, type="p", col="black")

#lignes pppsc
points(celllog$time,celllog$MixC_PPSCmoy_R, type="l", col="blue")
#replicats
points(celllog$time,celllog$MixC_PPSC1_R, type="p", col="blue")
points(celllog$time,celllog$MixC_PPSC2_R, type="p", col="blue")
points(celllog$time,celllog$MixC_PPSC3_R, type="p", col="blue")
...
## graphique problèmes
plot(cell_count$time, log(cell_count$Tol_PPmoy_G),ylim= c(log(2033.5),log(1136783330)), type = "l",cex.main=1.2,
     cex.lab=1.2, main = "SYTO-9 fluorescence \n Experiment 1",
     ylab = "log(Count of SYTO-9 stained cells)", xlab = "Time[hours]", col = "red" )
points(cell_count$time, log(cell_count$Tol_PPSCmoy_G), type = "l", col = "blue")
points(cell_count$time, log(cell_count$Tol_PPSC1_G),type = "p", col = "blue")
points(cell_count$time, log(cell_count$Tol_PPSC2_G),type = "p", col = "blue")
points(cell_count$time, log(cell_count$Tol_PPSC3_G),type = "p", col = "blue")

test1 <- (cell_count$Tol_PPSC1_G+cell_count$Tol_PPSC2_G+cell_count$Tol_PPSC3_G)/3

points(cell_count$time, log(cell_count$Tol_PP1_G),type = "p", col = "red")
points(cell_count$time, log(cell_count$Tol_PP2_G),type = "p", col = "red")
points(cell_count$time, log(cell_count$Tol_PP3_G),type = "p", col = "red")

legend(x = "bottomright",legend = c("PP alone in Tol", "PPSC in Tol"), fill = c("red", "blue"), cex=1.2)

###------------------------------------------------Comptes totaux
## MIx carbon PPsc moyenne
plot(cell_count$time, log(cell_count$MixC_PPSCmoy_G+cell_count$MixC_PPSCmoy_R),type = "l",
     cex.main=1.2,
     cex.lab=1.2, main = "Total count in Mixed Carbon \n Experiment 1",
     ylab = "log(cell count)", xlab = "Time[hours]", col = "orange", ylim=c(log(2950),log(4028683330)))
##points pour ppsc
points(cell_count$time, log(cell_count$MixC_PPSC1_G+cell_count$MixC_PPSC1_R),type = "p", col = "orange")
points(cell_count$time, log(cell_count$MixC_PPSC2_G+cell_count$MixC_PPSC2_R),type = "p", col = "orange")
points(cell_count$time, log(cell_count$MixC_PPSC3_G+cell_count$MixC_PPSC3_R),type = "p", col = "orange")
# PP seul moyenne
points(cell_count$time, log(cell_count$MixC_PPmoy_G+cell_count$MixC_PPmoy_R), type = "l", col = "red")
# pp seul points
points(cell_count$time, log(cell_count$MixC_PP1_G+cell_count$MixC_PP1_R), type = "p", col = "red")
points(cell_count$time, log(cell_count$MixC_PP2_G+cell_count$MixC_PP2_R), type = "p", col = "red")
points(cell_count$time, log(cell_count$MixC_PP3_G+cell_count$MixC_PP3_R), type = "p", col = "red")
## sc seul moy
points(cell_count$time, log(cell_count$MixC_SCmoy_G+cell_count$MixC_SCmoy_R), type = "l", col = "green")
## sc seul points
points(cell_count$time, log(cell_count$MixC_SC1_G+cell_count$MixC_SC1_R), type = "p", col = "green")
points(cell_count$time, log(cell_count$MixC_SC2_G+cell_count$MixC_SC2_R), type = "p", col = "green")
points(cell_count$time, log(cell_count$MixC_SC3_G+cell_count$MixC_SC3_R), type = "p", col = "green")
...
## dans le toluène
plot(cell_count$time, log(cell_count$Tol_PPmoy_G+cell_count$Tol_PPmoy_R),type = "l",
     cex.main=1.2,
     cex.lab=1.2, main = "Total count in Toluene \n Experiment 1",
     ylab = "log(cell count)", xlab = "Time[hours]", col = "red", ylim=c(log(2950),log(4028683330)))
## points pour les relicats pp
points(cell_count$time, log(cell_count$Tol_PP1_G+cell_count$Tol_PP1_R),type = "p", col = "red")
points(cell_count$time, log(cell_count$Tol_PP2_G+cell_count$Tol_PP2_R),type = "p", col = "red")
points(cell_count$time, log(cell_count$Tol_PP3_G+cell_count$Tol_PP3_R),type = "p", col = "red")
## les ligne pour les moyennes ppsc
points(cell_count$time, log(cell_count$Tol_PPSCmoy_G+cell_count$Tol_PPSCmoy_R), type = "l", col = "orange")
## les points pour les réplicats ppsc
points(cell_count$time,log( cell_count$Tol_PPSC1_G+cell_count$Tol_PPSC1_R), type = "p", col = "orange")
points(cell_count$time, log(cell_count$Tol_PPSC2_G+cell_count$Tol_PPSC2_R), type = "p", col = "orange")
points(cell_count$time, log(cell_count$Tol_PPSC2_G+cell_count$Tol_PPSC2_R), type = "p", col = "orange")
## lignes pour la moyenne sc
points(cell_count$time, log(cell_count$Tol_SCmoy_G+cell_count$Tol_SCmoy_R), type = "l", col = "green")
# points pour les réplicats sc
points(cell_count$time, log(cell_count$Tol_SC1_G+cell_count$Tol_SC1_R), type = "p", col = "green")
points(cell_count$time, log(cell_count$Tol_SC2_G+cell_count$Tol_SC2_R), type = "p", col = "green")
points(cell_count$time, log(cell_count$Tol_SC3_G+cell_count$Tol_SC3_R), type = "p", col = "green")
# légende
