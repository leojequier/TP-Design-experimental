...
points(cell_count2$time, cell_count2$MixC_PVSC3_G+ cell_count2$MixC_PVSC3_R,type = "p", col = "blue")
points(cell_count2$time, cell_count2$MixC_PVmoy_G+ cell_count2$MixC_PVmoy_R, type = "l", col = "black")
points(cell_count2$time, cell_count2$MixC_PV1_G+ cell_count2$MixC_PV1_R, type = "p", col = "black")
points(cell_count2$time, cell_count2$MixC_PV2_G+ cell_count2$MixC_PV2_R, type = "p", col = "black")
points(cell_count2$time, cell_count2$MixC_PV3_G+ cell_count2$MixC_PV3_R, type = "p", col = "black")
points(cell_count2$time,  cell_count2$MixC_SCmoy_G+ cell_count2$MixC_SCmoy_R, type = "l", col = "purple")
points(cell_count2$time,  cell_count2$MixC_SC1_G+ cell_count2$MixC_SC1_R, type = "p", col = "purple")
points(cell_count2$time,  cell_count2$MixC_SC2_G+ cell_count2$MixC_SC2_R, type = "p", col = "purple")
