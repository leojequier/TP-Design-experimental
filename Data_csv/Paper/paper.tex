...
Every few hours (see Fig. \ref{design_weeks} for precise times), we took 2 samples from each flask to make technical replicates, and stained them with 4 µL SYTO-9 (50 µM), a  green fluorescent nucleic acid stain\footnote{ref. https://www.thermofisher.com/order/catalog/product/S34854, Nov. 2017}.  We then added 200 µL of each sample to the wells of a 96-well plate.
...
\begin{figure}[H]
	...
	\caption{Week 1 - SC : AUC (Area Under the Curve). Each point represents the mean of the 2 technical replicates.}
	\label{aucscw1}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Week 2 - PP : AUC (Area Under the Curve). Each point represents the mean of the 2 technical replicates.}
	\label{aucppw1}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Week 2 - SC : AUC (Area Under the Curve). Each point represents the mean of the 2 technical replicates.}
	\label{aucscw2}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Week 2 - PV : AUC (Area Under the Curve). Each point represents the mean of the 2 technical replicates.}
	\label{aucppw2}
\end{figure}
